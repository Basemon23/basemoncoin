...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.basemoncoind,
            self.options.basemoncoind,
            releases_path + "/v0.19.0.1/bin/basemoncoind",
            releases_path + "/v0.18.1/bin/basemoncoind",
            releases_path + "/v0.17.1/bin/basemoncoind"
        ], binary_cli=[
            self.options.basemoncoincli,
            self.options.basemoncoincli,
            releases_path + "/v0.19.0.1/bin/basemoncoin-cli",
            releases_path + "/v0.18.1/bin/basemoncoin-cli",
            releases_path + "/v0.17.1/bin/basemoncoin-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes basemoncoind to exit, in addition to the RPC
