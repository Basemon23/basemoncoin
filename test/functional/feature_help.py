...
"""Verify that starting basemoncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start basemoncoin with -h for help text")
        ...
        self.log.info("Start basemoncoin with -version for version information")
        ...
        self.log.info("Start basemoncoind with -fakearg to make sure it does not start")
