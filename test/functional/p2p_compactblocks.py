...
# TestP2PConn: A peer we use to send messages to basemoncoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def test_sendcmpct(self, test_node, old_node=None):
        ...
        # Make sure we get a SEBASEMPCT message from our peer
        ...
        # Now try a SEBASEMPCT message with too-high version
        ...
        # Now try a SEBASEMPCT message with valid version, but announce=False
        ...
        # Finally, try a SEBASEMPCT message with announce=True
        sendcmpct.version = preferred_version
        sendcmpct.announce = True
        test_node.send_and_ping(sendcmpct)
    ...
    # This test actually causes basemoncoind to (reasonably!) disconnect us, so do this last.
    ...
    # basemoncoind's choice of nonce.
    ...
    # Test that basemoncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for basemoncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # basemoncoind will not send blocktxn responses for blocks whose height is
    ...
    def run_test(self):
        ...
        self.log.info("Testing SEBASEMPCT p2p message... ")
