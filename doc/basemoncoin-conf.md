# `basemoncoin.conf` Configuration File
...
-- | -- | --
Windows | `%APPDATA%\Bitcoin\` | `C:\Users\username\AppData\Roaming\Bitcoin\basemoncoin.conf`
Linux | `$HOME/.basemoncoin/` | `/home/username/.basemoncoin/basemoncoin.conf`
macOS | `$HOME/Library/Application Support/Bitcoin/` | `/Users/username/Library/Application Support/Bitcoin/basemoncoin.conf`
