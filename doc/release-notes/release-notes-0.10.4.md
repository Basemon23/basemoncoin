Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://basemoncoin.org/bin/basemoncoin-core-0.10.4/>
...
- #6953 `43c2789` Split basemoncoin-tx into its own package
- #6953 `dfe0d4d` Include basemoncoin-tx binary on Debian/Ubuntu
