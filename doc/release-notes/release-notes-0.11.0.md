Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://basemoncoin.org/bin/basemoncoin-core-0.11.0/>
...
For example, add the following to `basemoncoin.conf`:
...
related to the blockchain in the basemoncoin system: the raw blocks as received over 
...
For an example script see [basemoncoin-submittx](https://github.com/laanwj/basemoncoin-submittx).
...
- #5334 `cf87536` libbasemoncoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new basemoncoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add basemoncoin logo to about screen
...
- #5809 `46bfbe7` Add basemoncoin-cli man page
...
- #5849 `41259ca` contrib/init/basemoncoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for basemoncoin-tx)
