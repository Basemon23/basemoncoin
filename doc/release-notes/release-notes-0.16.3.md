Bitcoin Core version 0.16.3 is now available from:
  ...
  <https://basemoncoincore.org/bin/basemoncoin-core-0.16.3/>
...
### Miscellaneous
- #13655 `1cdbea7` basemoncoinconsensus: invalid flags error should be set to `basemoncoinconsensus_err` (afk11)
