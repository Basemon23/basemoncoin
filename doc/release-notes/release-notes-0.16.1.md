Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://basemoncoincore.org/bin/basemoncoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting basemoncoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure basemoncoind processes are cleaned up when tests end (sdaftuar)
