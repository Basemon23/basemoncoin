Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/basemoncoin/files/Bitcoin/basemoncoin-0.7.0/

We recommend that everybody running prior versions of basemoncoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/Basemon23/basemoncoin/tarball/v0.7.0  # .tar.gz
  https://github.com/Basemon23/basemoncoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the basemoncoin-qt package:
  sudo apt-get install basemoncoin-qt
...
Core basemoncoin handling and blockchain database
...
* Ensure a changed basemoncoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for basemoncoin-qt.exe
* (Windows only): add meta-data to basemoncoin-qt.exe (e.g. description)
...
* Bash programmable completion for basemoncoind(1)
