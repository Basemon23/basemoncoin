Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://basemoncoin.org/bin/basemoncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update basemoncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow basemoncoin-tx to create v2 transactions (BTCdrak)
