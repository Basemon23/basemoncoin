...
Arguments:
    <base_directory> - The base directory of a basemoncoin source code repository.
...
Arguments:
    <file> - A source file in the basemoncoin repository.
"""
