...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the basemoncoin repository."
  exit 1
fi
...
# See https://github.com/Basemon23/basemoncoin/issues/16064
...
echo 'When compiling basemoncoind, run `./configure` in the following way:'
echo
