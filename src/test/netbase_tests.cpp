...
{
    BOOST_CHECK(TestSplitHost("www.basemoncoincore.org", "www.basemoncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.basemoncoincore.org]", "www.basemoncoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.basemoncoincore.org:80", "www.basemoncoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.basemoncoincore.org]:80", "www.basemoncoincore.org", 80));
