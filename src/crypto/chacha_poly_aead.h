...
/* A AEAD class for ChaCha20-Poly1305@basemoncoin.
 *
 ...
 *
 * The chacha20-poly1305@basemoncoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@basemoncoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@basemoncoin are relatively fast in
