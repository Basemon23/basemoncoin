...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " basemoncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  basemoncoin-tx [options] <hex-tx> [commands]  Update hex-encoded basemoncoin transaction\n" +
            "or:     basemoncoin-tx [options] -create [commands]   Create hex-encoded basemoncoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded basemoncoin transaction
