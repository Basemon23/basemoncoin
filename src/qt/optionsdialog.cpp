    ...
    mapper(nullptr)
{
    ...
    ui->basemoncoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->basemoncoinAtStartup);
    ...
    ui->basemoncoinAtStartup->setToolTip(ui->basemoncoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->basemoncoinAtStartup->setText(ui->basemoncoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->basemoncoinAtStartup, OptionsModel::StartAtStartup);
