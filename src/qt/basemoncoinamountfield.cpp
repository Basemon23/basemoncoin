...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::BASE, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
#include <qt/basemoncoinamountfield.moc>
