...
libs = [
    'libbasemoncoin_cli',
    'libbasemoncoin_common',
    'libbasemoncoin_crypto',
    'libbasemoncoin_server',
    'libbasemoncoin_util',
    'libbasemoncoin_wallet_tool',
    'libbasemoncoin_wallet',
    'libbasemoncoin_zmq',
    'bench_basemoncoin',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/basemoncoin_config.h'), os.path.join(SOURCE_DIR, 'config/basemoncoin-config.h'))
