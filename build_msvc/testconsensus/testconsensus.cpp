...
// basemoncoin includes.
#include <..\src\script\basemoncoinconsensus.h>
...
int main()
{
    std::cout << "basemoncoinconsensus version: " << basemoncoinconsensus_version() << std::endl;
    ...
    auto op0Result = basemoncoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, basemoncoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
