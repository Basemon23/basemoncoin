...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_basemoncoin` executable (see https://github.com/Basemon23/basemoncoin/pull/13543),
...
options will be passed to basemoncoin's configure. In this case, `--disable-wallet`.
